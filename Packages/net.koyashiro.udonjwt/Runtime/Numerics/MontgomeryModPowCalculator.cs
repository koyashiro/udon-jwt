...
namespace Koyashiro.UdonJwt.Numerics
{
    public class MontgomeryModPowCalculator : UdonSharpBehaviour
    {
        ...
        public void ModPow(uint[] value, JwtDecorderCallback jwtDecorderCallback, MontgomeryModPowCalculagorCallback montgomeryModPowCalculagorCallback)
        {
            ...
            _jwtDecorderCallback.Progress = 0;
        ...
        public void _Loop()
        {
            if (_e > 0)
            {
                ...
                _e >>= 1;
                _jwtDecorderCallback.Progress += 1f / (float)_totalStep;
        ...
        {
            _isRunning = false;
            _jwtDecorderCallback.Progress = 1;
            _jwtDecorderCallback.OnProgress();
